...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { name: @visitor.name, note: @visitor.note, number_persons: @visitor.number_persons, phone: @visitor.phone, reservation_id: @visitor.reservation_id } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { name: @visitor.name, note: @visitor.note, number_persons: @visitor.number_persons, phone: @visitor.phone, reservation_id: @visitor.reservation_id } }
